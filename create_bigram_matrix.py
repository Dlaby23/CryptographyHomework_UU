...
def create_and_save_bigram_matrix():
    ...
    with open('/Users/vaclavdlabac/Desktop/Cryptography Homework/krakatit_processed.txt', 'r', encoding='utf-8') as f:
        text = f.read()
    ...
    # Uložení matice
    np.save('/Users/vaclavdlabac/Desktop/Cryptography Homework/czech_bigram_matrix.npy', bigram_matrix)
    
    # Uložení také jako pickle pro snadnější načítání s metadaty
    with open('/Users/vaclavdlabac/Desktop/Cryptography Homework/czech_bigram_data.pkl', 'wb') as f:
        pickle.dump({
...
def visualize_bigram_matrix(matrix, analyzer):
    ...
    plt.tight_layout()
    plt.savefig('/Users/vaclavdlabac/Desktop/Cryptography Homework/bigram_matrix_visualization.png', dpi=150)
    plt.close()
