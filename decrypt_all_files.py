...
def decrypt_file(filepath: str, cryptanalysis: MetropolisHastingsCryptanalysis, 
    ...
    print(f"Konečná fitness: {fitness_history[-1]:.4f}")
    print(f"Ukázka dešifrovaného textu: {best_text[:100]}")
    
    # Uložení výsledků
    output_dir = "/Users/vaclavdlabac/Desktop/Cryptography Homework/decrypted_results"
...
def decrypt_all_test_files():
    ...
    if successful > 0:
        ...
        print(f"Průměrná fitness: {avg_fitness:.4f}")
    
    # Uložení souhrnu
    summary_path = "/Users/vaclavdlabac/Desktop/Cryptography Homework/decrypted_results/summary.txt"
